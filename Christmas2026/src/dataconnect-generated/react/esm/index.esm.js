import { createPublicListRef, getPublicListsRef, createPrivateListRef, getMyPrivateListsRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useCreatePrivateList(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useGetMyPrivateLists(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts } = validateReactArgs(connectorConfig, dcOrOptions, options);
